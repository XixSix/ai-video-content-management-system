 ...
 *         jobType:
 *           type: string
 *           enum: [TRANSCRIBE, GENERATE_SUBTITLE, GENERATE_CHAPTERS, GENERATE_SHORT_CLIPS, GENERATE_SUGGESTIONS, BURN_SUBTITLE, PUBLISH]
 *         status:
 *           type: string
 *           enum: [PENDING, QUEUED, TRANSCRIBING, GENERATING_SUBTITLE, BURNING_SUBTITLE, GENERATING_CHAPTERS, GENERATING_SHORT_CLIPS, GENERATING_SUGGESTIONS, PUBLISHING, COMPLETED, FAILED]
 *         progress:
 *           type: integer
 *           nullable: true
 *           example: 55
