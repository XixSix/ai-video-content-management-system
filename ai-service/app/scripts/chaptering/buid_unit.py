...
from app.runtime.container import _build_chaptering_pipeline_config
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build chaptering timeline units from transcript JSON."
    )
    ...
    config = _build_chaptering_pipeline_config(get_settings())
...
def _build_units(
    ...
    *,
    ...
    if config.strategy == CHAPTERING_STRATEGY_WORD:
...
def _unit_config_output(config: ChapteringPipelineConfig) -> dict[str, Any]:
    return {
