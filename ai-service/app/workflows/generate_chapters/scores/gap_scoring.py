...
def gap_scores_to_candidates(
    ...
    return [
        ChapterCandidate(
            ...
            left_adjacent_unit_ids=gap_score.left_adjacent_unit_ids,
            right_adjacent_unit_ids=gap_score.right_adjacent_unit_ids,
            ...
            lexical_valley_depth_score=gap_score.lexical_valley_depth_score,
            semantic_valley_depth_score=gap_score.semantic_valley_depth_score,
...
def _score_gap(
    ...
    *,
    ...
    return ChapterGapScore(
        ...
        left_adjacent_unit_ids=[previous_unit.unit_id],
        right_adjacent_unit_ids=[current_unit.unit_id],
        left_text=left_text,
...
def _context_window_for_gap(
    ...
    *,
    ...
    candidate = ChapterCandidate(
        ...
        left_adjacent_unit_ids=[units[gap_unit_index - 1].unit_id],
        right_adjacent_unit_ids=[units[gap_unit_index].unit_id],
    )
