...
class TranscribeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Transcribe = channel.unary_unary(
                '/transcribe.v1.TranscribeService/Transcribe',
...
def add_TranscribeServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'transcribe.v1.TranscribeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('transcribe.v1.TranscribeService', rpc_method_handlers)
